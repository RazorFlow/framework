...
<h2>Methods</h2>
    ...
    <p>Add a select/dropdown filter which allows the user to select one
option from a list of pre-defined options.
This is displayed as a HTML Select input on the filter form.</p>
    <h4>Params</h4>
    ...
    <p>Add a multi-select filter which allows the user to select one
option from a list of pre-defined options. This is displayed as a HTML multi select input on the filter form.</p>
    <h4>Params</h4>
    ...
    <p>Adds a Date Range filter to the component. This filter can be used to select a date range, a start date and an end date.
range, a start date and an end date.</p>
    <h4>Params</h4>
    ...
    <p>
        <code>onApplyClick(cb)</code>
    </p>
    <p>Sets a callback for the apply click event</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    The callback which is called when submit is clicked
    ...
    <p>Returns all the input values provided in this component</p>
    <h4>Params</h4>
    ...
    <p>Returns an input value by id provided in this component</p>
    <h4>Params</h4>
...
window.doc_id = "js_FilterComponent";
</script>
<?php
