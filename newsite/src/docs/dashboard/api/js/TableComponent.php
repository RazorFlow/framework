    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <h1>Class TableComponent</h1>

<h4>new TableComponent()</h4>
...
<h2>Methods</h2>
        ...
        <div id="addRow" class='rfApiMethod'>
    
    <h3><a href="#addRow" class="rfDocPermalink pull-right">#</a>addRow</h3>
    <p>
        <code>addRow(rowData)</code>
    </p>
    <p>Add a row of data to the table.
This will need to be provided as a key-value object whose keys correspond to individual column keys</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    an key-value object containing the data to be displayed in a row.
        ...
        <div id="addColumn" class='rfApiMethod'>
    
    <h3><a href="#addColumn" class="rfDocPermalink pull-right">#</a>addColumn</h3>
    <p>
        <code>addColumn(id, name, options)</code>
    </p>
    <p>Adds a column definition to the table</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    A unique id for this column which also corrresponds to the keys of row objects
            ...
            <tr>
                ...
                <td>
                    The name of the column which is displayed in the table
            ...
            <tr>
                ...
                <td>
                    Configure how the data is displayed
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>number</td>
                                <td>Width of the cell in the table.</td>
                            </tr>
                            
                            <tr>
                                <td><code>textAlign</code></td>
                                <td>string</td>
                                <td>Text alignment of the column cells</td>
                            </tr>
                            
                            <tr>
                                <td><code>textBoldFlag</code></td>
                                <td>boolean</td>
                                <td>Whether text needs to be bolder</td>
                            </tr>
                            
                            <tr>
                                <td><code>textItalicFlag</code></td>
                                <td>boolean</td>
                                <td>Whether text needs to be italized</td>
                            </tr>
                            
                            <tr>
                                <td><code>rawHTML</code></td>
                                <td>boolean</td>
                                <td>Whether raw html needs to be rendered. It will be escaped by default.</td>
                            </tr>
                            
                            <tr>
                                <td><code>subCaption</code></td>
                                <td>boolean</td>
                                <td>Whether a number prefix or suffix needs to be there besides column heading.</td>
                            </tr>
                            
                            <tr>
                                <td><code>subCaptionUnits</code></td>
                                <td>string</td>
                                <td>A number prefix or suffix next to the column heading.</td>
                            </tr>
        ...
        <div id="setRowsPerPage" class='rfApiMethod'>
    
    <h3><a href="#setRowsPerPage" class="rfDocPermalink pull-right">#</a>setRowsPerPage</h3>
    <p>
        <code>setRowsPerPage(numRows)</code>
    </p>
    <p>Sets the number of rows per page in the table</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    the number of rows in a single page on the table
        ...
        <div id="addMultipleRows" class='rfApiMethod'>
    
    <h3><a href="#addMultipleRows" class="rfDocPermalink pull-right">#</a>addMultipleRows</h3>
    <p>
        <code>addMultipleRows(rows)</code>
    </p>
    <p>Adds multiple rows of data to the table at once.
Note that the each row need to be provided as a key-value object whose keys match the column keys</p>
    <h4>Params</h4>
    ...
    <tbody>
        ...
        <div id="clearRows" class='rfApiMethod'>
    
    <h3><a href="#clearRows" class="rfDocPermalink pull-right">#</a>clearRows</h3>
    <p>
        <code>clearRows()</code>
    </p>
...
window.doc_id = "js_TableComponent";
</script>
<?php
