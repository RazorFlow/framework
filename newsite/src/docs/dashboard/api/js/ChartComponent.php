...
<h2>Methods</h2>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    A bunch of options passed to as an object
                    
                        <table class="table table-condensed rfParamsTable"><thead><th>Name</th><th>Type</th><th>Description</th></thead>
                        <tbody>
                            
                            <tr>
                                <td><code>seriesDisplayType</code></td>
                                <td>string</td>
                                <td>The type of the series to draw on the chart</td>
                            </tr>
                            
                            <tr>
                                <td><code>seriesColor</code></td>
                                <td>string</td>
                                <td>The color of the series on the chart</td>
                            </tr>
                            
                            <tr>
                                <td><code>seriesHiddenFlag</code></td>
                                <td>boolean</td>
                                <td>Set this to true to hide the series (but visible on legend)</td>
                            </tr>
                            
                            <tr>
                                <td><code>seriesStacked</code></td>
                                <td>boolean</td>
                                <td>Specifies whether a series is stacked or not</td>
                            </tr>
                            
                            <tr>
                                <td><code>yAxis</code></td>
                                <td>string</td>
                                <td>Specifies the id of the axis if it is a dual axis chart</td>
                            </tr>
        ...
        <h4>Example</h4>
        <pre><code>var c1 = new rf.ChartComponent (&#39;c1&#39;);
...
c1.addSeries (&quot;foo&quot;, &quot;Foo&quot;, [1, 2, -3], {
    ...
    <tbody>
        ...
        <div id="setLabels" class='rfApiMethod'>
    
    <h3><a href="#setLabels" class="rfDocPermalink pull-right">#</a>setLabels</h3>
    <p>
        <code>setLabels(labelArray)</code>
    </p>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    An option array. See the guide for available options.
    ...
    <p>Add another Y-Axis to the chart.</p>
    <h4>Params</h4>
    ...
    <p>
        <code>onItemClick(callback)</code>
    </p>
    ...
    <p>Clears all the data in the chart. Use this function if you want to update the
chart with new data and labels.

Be sure to lock the component before</p>
    <h4>Params</h4>
...
window.doc_id = "js_ChartComponent";
</script>
<?php
