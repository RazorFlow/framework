    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <h1>Class ArrayUtils</h1>

<h4>new ArrayUtils()</h4>
...
<h2>Methods</h2>
        ...
        <div id="pluck" class='rfApiMethod'>
    
    <h3><a href="#pluck" class="rfDocPermalink pull-right">#</a>pluck</h3>
    <p>
        <code>pluck($data, $columnKey, $replaceEmptyWithNull)</code>
    </p>
    <p>This is a static method and can be used to extract a column from the result of a SQL query fetched as an associative array</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    The key of the column to pluck
                    
                </td>
            </tr>
        
            <tr>
                <td><code>$replaceEmptyWithNull</code></td>
                <td>
                    Boolean
                </td>
                <td>
                    If there is no item found on that key, replace with a null (default true)
