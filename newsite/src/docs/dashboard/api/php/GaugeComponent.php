    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <h1>Class GaugeComponent</h1>

<h4>new GaugeComponent()</h4>


    <p>inherits from 
        <a href=KPIComponent.php>KPIComponent</a>
    </p>
...
<h2>Methods</h2>
        ...
        <div id="setLimits" class='rfApiMethod'>
    
    <h3><a href="#setLimits" class="rfDocPermalink pull-right">#</a>setLimits</h3>
    <p>
        <code>setLimits(min, max)</code>
    </p>
    <p>Sets the maximum and minimum values of the gauge.</p>
    <h4>Params</h4>
...
<h2>Inherited Methods</h2>
    ...
    <p>
        <code>setValue($value, $options)</code>
    </p>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    A bunch of options to configure the display passed to as an associative array
    ...
    <tbody>
            ...
            <tr>
              ...
              <div id="onValueClick" class='rfApiMethod'>
    
    <h3><a href="#onValueClick" class="rfDocPermalink pull-right">#</a>onValueClick</h3>
    <p>
        <code>onValueClick($url)</code>
    </p>
    <p>Handles Click function on a value</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    Remote Url that updates the value
...
window.doc_id = "php_GaugeComponent";
</script>
<?php
