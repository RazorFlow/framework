...
<h2>Methods</h2>
    ...
    <p>
        <code>addColumn($id, $name, $opts)</code>
    </p>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    A unique id for this column which also corrresponds to the keys of row array
    ...
    <p>
        <code>addRow($row)</code>
    </p>
    <p>Add a row of data to the table. This will need to be provided as an associative array whose keys correspond to individual column keys.</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    An associative array containing the data to be displayed in a row
    ...
    <p>Adds multiple rows of data to the table at once. Note that the each row need to be provided as an associative array whose keys match the column keys</p>
    <h4>Params</h4>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    Array of row arrays, where each row is an associative array
    ...
    <p>Clears all the rows in the table.</p>
    <h4>Params</h4>
...
window.doc_id = "php_TableComponent";
</script>
<?php
