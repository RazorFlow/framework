...
/*
 * This example demonstrate how to create a new comment on a feedback.
 */
...
// ID of the feedback where the new comment will be posted
$feedback_id 	= 4;
...
// Create the comment
$result = $api->feedbacks->addComment($feedback_id, $comment_text, $person_id);
