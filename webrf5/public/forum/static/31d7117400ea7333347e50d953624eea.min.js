...
/** File: application/3.0.2/modules/announcements/assets/desktop/js/frontend.js **/
        ...
        controllers: {
            announcement: {
                ...
                show: function () {
                    App.onReady(function () {
                        ...
                        var hiddenList;
                        $('.rightarea div.announcement-previous-block').on(App.event.click(), '.show_all', function (event) {
                            event.preventDefault();
                            var $this = $(this);
                            if (!hiddenList) {
                            ...
                            this.innerHTML = hiddenList.hasClass('hidden') ? App.t('Show All') : App.t('Collapse');
                        });
                    });
                },
            ...
            announcements: {
                ...
                manage: function () {
                    App.onReady(function () {
                        /* @event click */
                        $('table.universal-table-admin a.idelete ').on(App.event.click(), function () {
                            return confirm(App.t("Are you sure? You can't UNDO this operation!"));
                        });
