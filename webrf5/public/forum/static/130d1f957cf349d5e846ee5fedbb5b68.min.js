...
/** File: application/3.0.2/assets/desktop/js/tagging.js **/
...
(function($) {
    ...
    $.fn.tagging = function(options) {
        ...
        var html_input_field = "<li class=\"tags-new\"><input class=\"tags-input\" type=\"text\" /></li>\n";
        el.html(html_input_field);

        tag_input = el.children(".tags-new").children(".tags-input");

        $(this).click(function(e){
            if (e.target.tagName == 'I') {
                $(e.target).closest(".tags-choice").remove();
            }
            else {
                tag_input.focus();
            }
        ...
        tag_input.focusout(function(event){
            event.preventDefault();

            $.each(tag_input.val().split(/[\s,]/), function (i, typed) {
                typed = typed.replace(/,+$/,"");
                typed = typed.trim();
        ...
        tag_input.keypress(function(event){
            if (event.which == BACKSPACE) {
                if (tag_input.val() == "") {
                    $(el).children(".tags-choice:last").remove();
                }
            }
            else if (event.which == COMMA || event.which == ENTER || event.which == SPACE) {
                event.preventDefault();
        ...
        function is_new (value){
            var is_new = true;
            this.tag_input.parents("ul").children(".tags-choice").each(function(i){
        ...
        function create_choice (value){
            var el = "";
            el  = "<li class=\"tags-choice\">\n";
            el += value + "\n";
            el += "<span class=\"sep\"><i class=\"ico-small iclose\"></i>\n</span>\n";
            el += "";
        ...
        if (typeof(options["defaultTags"]) != "undefined") {
