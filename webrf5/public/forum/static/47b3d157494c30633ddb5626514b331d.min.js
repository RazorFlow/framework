...
/** File: application/3.0.2/assets/desktop/js/jscolor/jscolor.js **/
...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			// picker
			p.box.style.width = 2*THIS.pickerInset + 2*THIS.pickerFace + jscolor.images.pad[0] + (THIS.slider ? 2*THIS.pickerInset + 2*jscolor.images.arrow[0] + jscolor.images.sld[0] : 0);
			p.box.style.height = 2*THIS.pickerInset + 2*THIS.pickerFace + jscolor.images.pad[1] + 'px';

			// picker border
			p.boxB.style.position = 'absolute';
			p.boxB.style.clear = 'both';
			p.boxB.style.left = (x-10)+'px';
...
$(document).ready(function(){
    jscolor.dir = App.baseUrl('/application/' + App.version + '/assets/desktop/js/jscolor/');
    jscolor.install();
});
