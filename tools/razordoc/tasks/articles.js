...
module.exports = function (grunt) {
    grunt.registerMultiTask ('articles', 'Generates articles', function () {
        ...
        var imagesPath = path.resolve(configDir, options.articles.imagesPhysicalPath);
        articlesGen.generate (articlesDir, templateDir, outputDir, partialsPath, imagesPath, linkPrefix, suffix, apiTree, apiLinkPrefix, toc, tocTree, options);
    });
};