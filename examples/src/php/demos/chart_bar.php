...
class SampleDashboard extends StandaloneDashboard {
  public function buildDashboard(){
    ...
    $chart->addSeries ("sales2013", "2013", [24400, 27800, 23800, 24800], array("seriesDisplayType"=> 'bar'));
    $chart->addSeries ("sales2012", "2012", [15000, 15000, 17500, 20000], array("seriesDisplayType"=> 'bar'));
