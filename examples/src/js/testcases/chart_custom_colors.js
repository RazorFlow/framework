StandaloneDashboard(function (db) {
    ...
    c4.addSeries("seriesD", "Series A", [1, 3, 6, 1, 4], {seriesDisplayType: 'column', seriesColor: 'rgb(0, 255, 255)'});
    ...
    c5.addSeries("seriesC", "Series A", [4, 5, 5, 7, 9], {seriesDisplayType: 'bar', seriesColor: 'green'});
    c5.addSeries("seriesD", "Series A", [1, 3, 6, 1, 4], {seriesDisplayType: 'bar', seriesColor: 'rgb(0, 255, 255)'});
    c5.addSeries("seriesE", "Series B", [2, 1, 9, 2, 3], {seriesDisplayType: 'bar', seriesColor: '#F0F'});
    db.addComponent(c5);
});
